...
cp /home/centos/roboshop-shell-tf/catalogue.service /etc/systemd/system/catalogue.service
...
cp /home/centos/roboshop-shell-tf/mongo.depo /etc/yum.repos.d/mongo.repo &>>$LOGFILE
...
mongo --host mongodb.tmcdevops.online </app/schema/catalogue.js &>>$LOGFILE
